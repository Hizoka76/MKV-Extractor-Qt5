...
"V_AVS2": ["avs", "Individual pictures of AVS2-P2"],
...
"A_QUICKTIME/QDM2": ["qdm2", "QDesign Music v2"],
...
"S_TEXT/WEBVTT": ["vtt", "Web Video Text Tracks Format"],
"S_DVBSUB": ["dvb", "Digital Video Broadcasting (DVB) subtitles"],
...
"S_HDMV/TEXTST": ["tst", "HDMV text subtitles"]
}
